...
echo "__________________________________________________"
select version in '设置中文语言' '一键安装Node.js&Redis&Git' '安装Node.js' '安装Redis' '安装Git' 'SSH管理' '启动机器人' '关闭机器人' '进入Yunzai-BotV2模式'  '进入Yunzai-BotV3模式' '重启服务器' '退出';
do
case $version in
'设置中文语言')
clear
...
echo "提示：先安装基础三件，再进入版本模式"
echo "__________________________________________________"
select version in '下载中文包' '查看所有语言' '查看当前语言' '编辑语言' '重启服务器' '退出' ;
do
case $version in
'下载中文包')
clear
...
echo "提示：严格按数字顺序安装！"
echo "__________________________________________________"
select version in '安装Yunzai-BotV2' 'V2加载依赖' '安装ChromiumV2'  '安装miao-pluginV2' '更新Yunzai-BotV2&miao-plugin' 'V2初始化' '修改V2配置' '删除帮助底图' '删除V2配置' '卸载Yunzai-BotV2'  '退出';
do
case $version in
'安装Yunzai-BotV2')
clear
...
echo "提示：严格按数字顺序安装！"
echo "__________________________________________________"
select version in '安装Yunzai-BotV3' 'V3加载依赖' '安装ChromiumV3'  '安装miao-pluginV3' '更新Yunzai-BotV3&miao-plugin' 'V3初始化' '删除V3QQ配置' '卸载Yunzai-BotV3'  '退出';
do
case $version in
'安装Yunzai-BotV3')
clear
